...
import com.macro.mall.common.constant.CouponUseStatus;
...
public class UmsMemberCouponServiceImpl implements UmsMemberCouponService {
    ...
    public void add(Long couponId) {
        ...
        //未使用
        couponHistory.setUseStatus(CouponUseStatus.UNUSED.getValue());
    ...
    private BigDecimal calcTotalAmount(List<CartPromotionItem> cartItemList) {
        ...
        for (CartPromotionItem item : cartItemList) {
            ...
            BigDecimal realPrice = item.getPrice().subtract(item.getReduceAmount() != null ? item.getReduceAmount() : BigDecimal.ZERO);
