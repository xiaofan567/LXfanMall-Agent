...
-- ----------------------------
-- Table structure for oms_logistics_trace
-- ----------------------------
...
CREATE TABLE `oms_logistics_trace` (
  ...
  `location` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '轨迹地点',
  `status_text` varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '轨迹状态描述',
  `status_code` int(3) DEFAULT NULL COMMENT '轨迹状态编码',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `idx_order_id` (`order_id`),
  KEY `idx_delivery_sn` (`delivery_sn`)
) ENGINE = InnoDB DEFAULT CHARSET = utf8 COLLATE = utf8_general_ci COMMENT = '物流轨迹表' ROW_FORMAT = DYNAMIC;
...
-- ----------------------------
-- Table structure for ums_token_usage (AI Token用量记录表)
-- ----------------------------
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='AI Token用量记录表';
