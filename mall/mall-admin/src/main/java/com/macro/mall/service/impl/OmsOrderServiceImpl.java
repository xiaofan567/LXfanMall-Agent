...
public class OmsOrderServiceImpl implements OmsOrderService {
    ...
    public int delivery(List<OmsOrderDeliveryParam> deliveryParamList) {
        ...
        List<OmsOrderOperateHistory> operateHistoryList = deliveryParamList.stream()
                .map(omsOrderDeliveryParam -> {
                    ...
                    history.setOrderStatus(OrderStatus.SHIPPED.getValue());
    ...
    public int close(List<Long> ids, String note) {
        ...
        example.createCriteria().andDeleteStatusEqualTo(DeleteStatus.NOT_DELETED.getValue()).andIdIn(ids);
    ...
    @Override
    public LogisticsDetailResult getLogisticsDetail(Long id) {
        ...
        //查询物流轨迹
        result.setTraceList(orderDao.getLogisticsTrace(id));
        return result;
    }
}
